...
Native App zu [s3mail](https://github.com/ohartwig/s3mail). Der Entwurf steht
dort in [`IOS.md`](https://github.com/ohartwig/s3mail/blob/main/IOS.md); hier
steht, was davon gebaut ist.

> **In English:** [`README.md`](README.md) ist die kürzere englische
> Eingangsseite. Diese Seite ist das Bautagebuch: was gebaut ist, und warum so.
...
`mobile/go.mod` verlangt `github.com/ohartwig/s3mail` in einer festen Version —
