...
public struct MailboxView: View {
    ...
    public var body: some View {
        NavigationSplitView {
            List(model.folders, selection: Binding(
                ...
                .navigationTitle(model.folders.isEmpty ? "s3mail" : "Postfach")
        } content: {
            list
        } detail: {
            if let selected {
                ...
                ContentUnavailableView("Keine Nachricht gewählt", systemImage: "envelope")
            }
        }
    ...
    @ViewBuilder private var list: some View {
        ...
        case .failed(let text) where model.messages.isEmpty:
            ...
            ContentUnavailableView("Kein Zugriff", systemImage: "exclamationmark.triangle",
        ...
        default:
            ...
            .searchable(text: Binding(get: { model.query },
                        ...
                        prompt: "from: subject: after: is:unread")
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 2) {
            ...
            HStack(spacing: 6) {
                ...
                if message.spam { Tag(text: "Spam", bad: true) }
